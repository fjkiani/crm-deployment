    ...
    if site and key and secret:
        ...
        try:
            async with httpx.AsyncClient(timeout=10.0) as client:
                r = await client.post(f"{site}/api/method/crm.api.ai.ping", json={}, headers=headers)
                r.raise_for_status()
                print("✅ CRM ping OK")
        except Exception as e:
            print(f"⚠️ CRM ping failed: {e}")
