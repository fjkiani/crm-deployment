...
NEVER say you cannot search. ALWAYS use the search_pubmed_articles tool with specific keywords based on the user query. Do not hallucinate gut microbiota unless specifically asked. Focus on pharmacogenomics, toxicity prevention, and the specific genes mentioned (DPYD, TPMT, UGT1A1)."""
...
NEVER say you cannot search. ALWAYS use the search_clinical_trials tool with the requested condition. Focus on finding actual PGx trials and outcome measures."""