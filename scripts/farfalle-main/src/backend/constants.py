...
model_mappings: dict[ChatModel, str] = {
    ...
    # Gemini defaults (overridable via env)
    ChatModel.GEMINI_1_5_PRO: os.environ.get("GEMINI_1_5_MODEL", "gemini/gemini-1.5-pro"),
    ChatModel.GEMINI_2_5_PRO: os.environ.get("GEMINI_2_5_MODEL", "gemini/gemini-2.5-pro"),
    # Local models
